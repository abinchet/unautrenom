...
function createTextTexture(gl, text, font = "bold 30px monospace") {
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      {
        image: `/assets/img/mathysnb.webp`,
        text: "",
      },
      {
        image: `/assets/img/tom.webp`,
        text: "",
      },
      {
        image: `/assets/img/hedi1.webp`,
        text: "",
      },
      {
        image: `/assets/img/gero.webp`,
        text: "",
      },
      {
        image: `/assets/img/maia.webp`,
        text: "",
      },
      {
        image: `/assets/img/clem.webp`,
        text: "",
      },
      {
        image: `/assets/img/lucas.webp`,
        text: "",
      },
      {
        image: `/assets/img/etec1.webp`,
        text: "",
      },
      {
  ...
  onCheck() {
    // Disabled - auto scroll only (no snapping to items)
    return;
  }
  onResize() {
    this.screen = {
  ...
  addEventListeners() {
    ...
    // All interaction events disabled for auto-scroll only mode
  }
  destroy() {
    window.cancelAnimationFrame(this.raf);
    window.removeEventListener("resize", this.boundOnResize);
    // Interaction event listeners removed since they're disabled
    if (
      this.renderer &&
      this.renderer.gl &&
